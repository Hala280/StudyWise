// Navbar.js
// Usage: import { createNavbar } from './components/Navbar.js';
//        document.getElementById('nav-root').appendChild(createNavbar({ active: 'home' }));
// Remember to call bindThemeToggle() from theme.js AFTER this is inserted into the DOM.

/**
 * @param {Object} opts
 * @param {'home'|'components'} [opts.active]
 * @returns {HTMLElement}
 */
export function createNavbar({ active = 'home' } = {}) {
